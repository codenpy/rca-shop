...
class Alg_WC_Global_Shop_Discount_Core {
	 ...
	 * @since   1.0.0
	 *
	 * @todo    [later] (feature) fee instead of discount
	 * @todo    [later] (feature) regular price coefficient (`$this->product_get_regular_price_filter, 'woocommerce_variation_prices_regular_price', 'woocommerce_product_variation_get_regular_price'`)
	 * @todo    [maybe] (feature) "direct price"
	 */
	...
	function init_options() {
		...
		foreach ( $taxonomies as $taxonomy ) {
			...
			$group_options[ "{$id}_incl" ] = '';
			$group_options[ "{$id}_excl" ] = '';
		}
	 ...
	 * @since   1.0.0
	 *
	 * @todo    [later] (feature) global shipping discount
	 */
	 ...
	 * @since   1.0.0
	 *
	 * @todo    [next] (feature) by product meta, e.g. `total_sales`
	 */
