...
$instructor = $edumall_course->get_instructors();

if ( $instructor ) {
	?>
	<div class="tutor-single-course-segment tutor-course-instructors-wrap" id="single-course-ratings">
		<h4 class="tutor-segment-title"><?php esc_html_e( 'Your Instructor', 'edumall' ); ?></h4>
		<?php
			...
			<div class="single-instructor-wrap">
				<div class="instructor-avatar">
					<a href="<?php echo esc_url( $profile_url ); ?>">
                        <?php echo edumall_get_avatar( $instructor->ID, 300 ); ?>
<!--                        <img src="https://online.chess-teacher.com/wp-content/uploads/2016/02/Igor.jpg" alt="">-->
					</a>
				</div>
