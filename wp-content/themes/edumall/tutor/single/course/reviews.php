...
<div class="tutor-single-course-segment tutor-course-reviews-wrap">
	...
	<?php if ( ! empty( $reviews ) ) : ?>
		...
		<div class="tutor-course-reviews-average-wrap">
			<h4 class="tutor-segment-title"><?php esc_html_e( 'CUSTOMER REVIEWS', 'edumall' ); ?></h4>
					...
					<div class="<?php echo esc_attr( $wrapper_class ); ?>">
						<div class="review-header">
							<div class="review-avatar">
                                <img src="https://ui-avatars.com/api/?background=0D8ABC&color=fff&name=<?php echo $review->comment_author; ?>" alt="">
							</div>
