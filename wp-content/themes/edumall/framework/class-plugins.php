		...
		public function register_required_plugins( $plugins ) {
			...
			$new_plugins = array(
				array(
					...
					'slug'     => 'insight-core',
					'source'   => $this->get_plugin_source_url( 'insight-core-2.2.7-SKvs3RABHM.zip' ),
					'version'  => '2.2.7',
					'required' => true,
				),
				array(
				...
				array(
					...
					'slug'    => 'revslider',
					'source'  => $this->get_plugin_source_url( 'revslider-6.5.11-BSgd5uLbiK.zip' ),
					'version' => '6.5.11',
				),
				array(
				...
				array(
					...
					'source'  => $this->get_plugin_source_url( 'insight-swatches-1.2.4-eUhbSfkI5b.zip' ),
					'version' => '1.2.4',
				),
				array(
				...
				array(
					...
					'slug'    => 'tutor-pro',
					'source'  => $this->get_plugin_source_url( 'tutor-pro-1.9.12-xhFoRDYJLK.zip' ),
					'version' => '1.9.12',
				),
				/**
				...
				array(
					...
					'source'  => $this->get_plugin_source_url( 'tutor-lms-certificate-builder-1.0.1-vVPChB42Jv.zip' ),
					'version' => '1.0.1',
				),
			);
